...
export default function FliserensPage() {
  ...
  const service = services.find((s) => s.id === "fliser");
  ...
  const benefits = [
    "Fjerner flisepest, alger og indgroet snavs",
    "Genskaber flisernes oprindelige farve",
    "Gør overfladen mindre glat og mere sikker",
    "Forlænger flisernes levetid markant",
    "Mulighed for efterbehandling og imprægnering for ekstra beskyttelse"
  ];
    ...
    <>
      <div className="relative min-h-screen pt-40 pb-16">
        <div className="absolute inset-0 -z-10">
          <Image
            src="/images/flise.png"
            alt="Fliserens baggrund"
            fill
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-stretch mb-16 max-w-6xl mx-auto">
            ...
            <div className="flex flex-col justify-start space-y-6 motion-reduce:animate-none animate-slide-in-left">
              <h2 className="text-4xl font-bold text-white drop-shadow-lg leading-tight">
                Fliserens – giv dine fliser nyt liv
              </h2>

              <p className="text-lg text-white/95 drop-shadow leading-relaxed">
                Med tiden bliver fliser mørke og glatte af alger, flisepest og snavs. En professionel fliserens fjerner de dybtliggende belægninger og giver dine fliser deres oprindelige udseende tilbage – hurtigt, effektivt og skånsomt.
              </p>
            </div>

            {/* Right column - Benefits bullets */}
            <div className="flex flex-col justify-start motion-reduce:animate-none animate-slide-in-right">
              <h3 className="text-2xl font-bold text-white drop-shadow-lg mb-4">Fordele ved fliserens:</h3>
